#Весь юзербот является экспериментом: "Сможет ли нейросеть написать полноценный юзербот?". По чему-то писать ему: @rav1non or @k3rn3I (телеграм)
